...
# the integrator term, but reset the sum(dT0) to zero once the target temperature
...
if USE_INTEGRATOR_RESET:
    ...
    if not firsttime==1: # prior control log data only exists when this script has been run before
